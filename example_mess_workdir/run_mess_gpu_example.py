...
time_range = '20190704-20190713'
sta_file = 'input/rc_scsn_pad.sta'
temp_root = '/data4/bigdata/zhouyj/RC_templates'
temp_pha = 'input/rc_pad.temp'
out_root = 'output/rc'
out_ctlg = os.path.join(out_root, 'phase_{}.dat'.format(time_range))
out_pha = os.path.join(out_root, 'catalog_{}.dat'.format(time_range))
